...
const Page = () => {
  ...
  return (
    <div className="mx-auto w-full max-w-8xl  px-4 sm:px-6 lg:px-8">
      {/* Hero Section */}
      <div className="flex flex-col items-center gap-5 sm:gap-6 md:gap-7 xl:gap-15 w-full h-auto mt-0 2xl:mt-80 relative">
        <h1
        ...
        <div
          className="hero-subtext px-4 sm:px-6 md:px-10 py-4 sm:py-5 md:py-6 
                bg-neutral-800/20 rounded-xl outline -outline-offset-1 outline-neutral-800 
                backdrop-blur-[6px] flex flex-wrap justify-start items-center gap-x-2 sm:gap-x-3 md:gap-x-4 
                space-y-2 sm:space-y-3 md:space-y-4"
        >
          <p className="text-sm sm:text-base md:text-lg leading-relaxed">
            for{" "}
            <span className="sm:px-3.5 sm:py-3 sm:bg-neutral-800 sm:rounded-lg sm:inline-flex sm:text-sm md:text-base">
              Startups
            </span>
            ,{" "}
            <span className="sm:px-3.5 sm:py-3 sm:bg-neutral-800 sm:rounded-lg sm:inline-flex sm:text-sm md:text-base">
        ...
        <div className="hero-buttons flex flex-row flex-wrap gap-3 sm:gap-4 pb-15">
        ...
        <Image
          ...
          width={2920}
          height={1080}
          className="w-full h-auto z-[-5] absolute bottom-0"
        />
      </div>
